...
<body>
	...
	<img src="/bbs/images/catjelly.png" width="100" height="100">
	...
	<img src = "/bbs/images/psy/munchiken.jpg" style="width:600px; height: 400px; object-fit: cover;"><br></div>
	<div style="margin-left:30%;margin-top:30px">
	<div style="font-size:50pt;margin-top:20px">
	먼치킨 고양이 !!!</div>
	
	<div style="margin-top:30px;font-size:20pt;color:gray;margin-bottom:40px">친구의 의견을 들어 주려는 노력을 하는 모습도 좋지만 규칙과 상식을 중시하고 책임감이 강한 타입<br><br>
	다른 사람을 배려하고 맞춰 주려는 노력으로 언제나 환영받지만<br><br> 그러다 보니 필요 이상으로 참거나 상대에게 이용되는 경우가 있어 스트레스를 받기도 합니다.<br><br>
	그런 당신에게 어울리는 먼치킨 고양이는 먼치킨은 사교적인 성격으로 장난을 좋아한다. 호기심이 많고 장난감을 가지고 잘 논다. <br><br>
	활발하면서도 다정하며,독립적인 성향이 덜하므로 당신에게 딱맞는 반려동물이다.
	</div>
	</div>
	</div>	
</body>
