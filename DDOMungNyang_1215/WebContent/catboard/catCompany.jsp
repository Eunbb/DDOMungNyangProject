	...
	<div id="page-wrapper">
		...
		%>
			<button id="logout_btn"
				onclick="location.href='/bbs/member.jsp'">회원관리</button>
		...
		<section id="header">
			...
			<nav id="nav">
				<ul>
					...
					<li class="current"><a href="/bbs/Iblist4.do?pg=1">고양이 분양</a>
						<ul>
							<li><a href="/bbs/Iblist4.do?pg=1" style="color: #FA8072">업체
									분양</a></li>
				...
				<div class="row">
					<div class="col-8 col-12-medium">
						<section id="footer">
							<header>
								<h2
									style="text-align: left; color: white; font-size: 2.3em; margin-bottom: 2em">DDO:MungNyang</h2>
							</header>
							<ul class="dates">
