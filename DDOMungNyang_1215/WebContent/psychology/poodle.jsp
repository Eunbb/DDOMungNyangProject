...
<body>
	...
	<img src = "/bbs/images/psy/poodle_psycho.jpg" style="width:600px; height: 400px; object-fit: cover;"><br></div>
	<div style="margin-left:30%;margin-top:30px">
	<div style="font-size:50pt;margin-top:20px">
	푸들 강아지 !!!</div>
	
	<div style="margin-top:30px;font-size:20pt;color:gray;margin-bottom:40px">
	솔직 담백한 성격으로 우정을 중시하는 성격 덕분에 주변에 친구와 사람이 많은 당신! <br><br>
	주관이 뚜렷하고 지는 걸 싫어하지만 착실한 성격 탓에 누구보다 노력하는 성격을 가지고 있습니다.<br><br>
	그런 당신에게 어울리는 푸들은 공격성이 낮고 활발한 성격을 가지고 있습니다.<br><br>
	또한 주인에게 충성심이 높고 애교와 재롱 부리는 것을 좋아합니다. 사교적인 성격과 온화한 성격 덕분에 다른 동물들과도 조화롭게 지내는 편이며 활동하는 것을 좋아하는 성격입니다.
	</div>
	</div>
	</div>	
</body>
