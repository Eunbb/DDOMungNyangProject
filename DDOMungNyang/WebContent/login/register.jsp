...
<body class="homepage is-preload">
	<div id="page-wrapper">
		...
		<form class="form-horizontal" action="/bbs/SignUp.do" method="post" name="signup">
			<div id="container">
					...
					<div class="row_group">
						<div class="join_row">
							...
							<div class="inputWrap">
								...
								<div class="adress_button">
									<input type="submit" id="adress_button" onclick=""
										style="font-size:0.8em;margin:0" value="이메일인증" class="btn">
								</div>
					...
					<div class="row_group">
						<div class="join_row">
							<div class="col-sm-12  text-center">
								...
								<input type="submit" style="font-size:0.8em; margin:20px" value="가입하기" class="btn btn-success">
							</div>
						</div>
					</div>
